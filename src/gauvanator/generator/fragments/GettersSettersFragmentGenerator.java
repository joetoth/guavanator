...
public class GettersSettersFragmentGenerator {
	...
	public String generate() {
		...
		for (IField field : fields) {
			...
			builder.append("public " + type + " get" + capitalizedFieldName + "() { return " + fieldName
					+ "; } ");
	...
	public static String generate(ICompilationUnit compilationUnit) {
		GettersSettersFragmentGenerator generator = new GettersSettersFragmentGenerator(compilationUnit);
