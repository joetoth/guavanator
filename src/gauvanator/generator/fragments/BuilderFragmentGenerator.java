...
public class BuilderFragmentGenerator {
  ...
  public String generate() {
    ...
    for (IField field : fields) {
      ...
      builder.append("public Builder set" + CompilationUtils.capitalize(name) + "(" + type + " "
          + name + ") {");
  ...
  public static String generate(ICompilationUnit compilationUnit) {
    BuilderFragmentGenerator generator = new BuilderFragmentGenerator(compilationUnit);
